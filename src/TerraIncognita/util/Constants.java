...
public class Constants {
    ...
    public static final int SWARM_COUNT = 50; // số quái trong bầy — sửa ở đây để đổi số lượng
    ...
    public static final double SWARM_BASE_SPEED = 55; // maxspeed lúc bình thường (pixel/giây) — tương đương "maxspeed"
                                                      // trong NOC Boid
    public static final double SWARM_PANIC_SPEED = 130; // maxspeed khi đang hoảng loạn né player/bomb
    public static final double SWARM_MAX_FORCE = 120; // maxforce — giới hạn độ lớn lực steering mỗi behavior
                                                      // (pixel/giây^2), tương đương "maxforce" trong NOC Boid
    public static final double SWARM_PANIC_RADIUS = 100; // player đứng gần hơn khoảng cách này -> quái né ra xa
                                                         // (desiredSeparation cho flee)
    public static final double SWARM_NEIGHBOR_RADIUS = 90; // bán kính "nhìn thấy" đồng loại để tính bay đàn
    public static final double SWARM_SEPARATION_RADIUS = 34; // bán kính bắt đầu đẩy nhau ra (lực mềm, theo thuật toán
                                                             // boid)
    public static final double SWARM_MIN_SEPARATION_DISTANCE = 22; // khoảng cách TỐI THIỂU giữa 2 tâm quái — ép cứng
                                                                   // mỗi frame để đảm bảo không chồng lấn hình ảnh
                                                                   // (hitbox 12x12 -> chồng nếu < 12, đặt 22 để còn
                                                                   // khoảng hở rõ mắt)
    public static final double SWARM_EXPLOSION_FLEE_RADIUS = 150; // bán kính bị "hất văng" khi bomb nổ gần (rộng hơn
                                                                  // vùng bomb gây sát thương)
